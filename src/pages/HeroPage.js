  ...
  return (
    <div className={`hero-page bg-${theme}`} data-bs-theme={theme}>
      ...
      <section className="hero-banner position-relative d-flex align-items-center">
        {/* If you want a video background, uncomment it here */}

        <Container>
          {/* 1) Row for the heading + “Learn More” arrow */}
          ...
          {/* 2) Row for side-by-side search bar + selected Pokémon card */}
          <Row className="align-items-start mt-4">
            {/* Left side: Search Bar (full width on mobile, half on md+) */}
            ...
            {/* Right side: Pokémon card (only if one was selected) */}
            <Col xs={12} md={6} className="mb-3">
      ...
      <section className="cta-section text-center py-5">
        <Container>
            ...
            <p className="mb-4">
                Create an account to join the fun, track your progress, and become the ultimate Pokémon trainer.
            </p>
